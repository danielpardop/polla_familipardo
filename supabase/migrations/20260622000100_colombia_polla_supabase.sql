...
insert into public.players (team_name, name, display_order)
values
  ('Colombia', 'Luis Diaz', 1),
  ('Colombia', 'James Rodriguez', 2),
  ('Colombia', 'Jhon Arias', 3),
  ('Colombia', 'Jhon Duran', 4),
  ('Colombia', 'Rafael Santos Borre', 5),
  ('Colombia', 'Luis Sinisterra', 6),
  ('Colombia', 'Jaminton Campaz', 7),
  ('Colombia', 'Daniel Munoz', 8),
  ('Colombia', 'Jefferson Lerma', 9),
  ('Colombia', 'Yerry Mina', 10),
  ('Uzbekistan', 'Abbosbek Fayzullaev', 1),
  ('Uzbekistan', 'Eldor Shomurodov', 2),
  ('Uzbekistan', 'Jaloliddin Masharipov', 3),
  ('Uzbekistan', 'Oston Urunov', 4),
  ('R. D. del Congo', 'Cedric Bakambu', 1),
  ('R. D. del Congo', 'Yoane Wissa', 2),
  ('R. D. del Congo', 'Silas', 3),
  ('R. D. del Congo', 'Theo Bongonda', 4),
  ('R. D. del Congo', 'Chancel Mbemba', 5),
  ('Portugal', 'Cristiano Ronaldo', 1),
  ('Portugal', 'Bruno Fernandes', 2),
  ('Portugal', 'Bernardo Silva', 3),
  ('Portugal', 'Rafael Leao', 4),
  ('Portugal', 'Goncalo Ramos', 5),
  ('Portugal', 'Joao Felix', 6),
  ('Portugal', 'Diogo Jota', 7);
