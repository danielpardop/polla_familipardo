...
export function PageHeader({
  ...
  return (
    <div
      className={cn(
        "relative overflow-hidden rounded-lg border bg-white p-4 shadow-soft sm:p-5",
        className,
      )}
    >
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div className="min-w-0">
          ...
          <h1 className="mt-1 text-xl font-black leading-tight text-primary sm:text-3xl">{title}</h1>
